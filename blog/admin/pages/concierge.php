...
$(window).load(function(){
	$('.trash').click(function(){
		var id=$(this).data('id');
		$('#modalDelete').attr('href','?dispatch=concierge.delete&id='+id);
	})
});//]]> 
</script>
			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					...
					<div class="box-header">
						<h3 class="box-title"><a href="?dispatch=concierge.add" class="btn btn-block btn-primary">Add New</a></h3>
					</div>
					...
					<div class="box-body table-rowdata">
						...
						<tbody>
							<?php
							$s_no = 1;
							$results = $mysqli->query("SELECT * FROM `Concierge`");
							if ($results) { 
							...
							?>                        
									<tr><td><input type="checkbox">&nbsp;&nbsp;<a href="#confirm-modal" data-toggle="modal" class="trash" data-id="<?php echo $obj->ID ?>" data-target="#confirm-modal"><i class="fa fa-trash-o"></i></a></td>
										<td><?php echo $s_no ?></td>
										<td><a href="?dispatch=concierge.update&id=<?php echo $obj->ID ?>"><?php echo $obj->Title ?></a></td>
