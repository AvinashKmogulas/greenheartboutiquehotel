<?php
	...
	if (! empty($errors)) {
		...
		$query = 	"INSERT INTO `Meetings` ( `Title`, `Subtitle`, `Description`, `BookingUrl`, `QueryEmail`, `SortOrder`, `Status`) 
					VALUES 
					(
						...
						'" . $mysqli->real_escape_string($_POST['form_data']['BookingUrl']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['QueryEmail']) . "',
