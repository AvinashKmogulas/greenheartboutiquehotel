...
$(window).load(function(){
	$('.trash').click(function(){
		var id=$(this).data('id');
		$('#modalDelete').attr('href','?dispatch=stay.delete&id='+id);
	})
});//]]> 
</script>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#">Stay</a></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					...
					<div class="box-header">
						<h3 class="box-title"><a href="?dispatch=stay.add" class="btn btn-block btn-primary">Add New</a></h3>
					</div>
					...
					<div class="box-body table-rowdata">
						...
						<tbody>
							<?php
							$s_no = 1;
							$results = $mysqli->query("SELECT * FROM `Stay`");
							if ($results) { 
							...
							?>                        
									<tr><td><input type="checkbox">&nbsp;&nbsp;<a href="#confirm-modal" data-toggle="modal" class="trash" data-id="<?php echo $obj->ID ?>" data-target="#confirm-modal"><i class="fa fa-trash-o"></i></a></td>
										<td><?php echo $s_no ?></td>
										<td><a href="?dispatch=stay.update&id=<?php echo $obj->ID ?>"><?php echo $obj->Title ." ". $obj->SubTitle ?></a></td>
