<?php
	...
	if (! empty($errors)) {
		...
		$query = 	"INSERT INTO `Gallery` ( `Title`, `Pic`, `FilterStay`, `FilterDine`, `FilterWeddings`, `FilterEvents`, `FilterExperience`, `FilterOthers`, `SortOrder`, `Status`) 
					VALUES 
					(
						'" . $mysqli->real_escape_string($_POST['form_data']['Title']) . "',
						'" . $mysqli->real_escape_string($ufile1_path) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterStay']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterDine']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterWeddings']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterEvents']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterExperience']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['FilterOthers']) . "',
