					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="form_data[Name]" id="elm_name" value="" />
							</div>
						
							<div class="form-group">
								<label for="elm_designation">Designation</label>
								<input type="text" class="form-control" name="form_data[Designation]" id="elm_designation" value="" />
							</div>
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/team/" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Team`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
