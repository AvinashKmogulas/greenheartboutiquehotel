					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="form_data[SubTitle]" id="elm_subtitle" value="" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="form_data[Cuisine]" id="elm_cuisine" value="" />
									</div>
									
									<div class="form-group">
										<label for="elm_timings">Dining Timings</label>
										<input type="text" class="form-control" name="form_data[Timings]" id="elm_timings" value="" />
									</div>
									
									<div class="form-group">
										<label for="elm_phone">Phone</label>
										<input type="text" class="form-control" name="form_data[Phone]" id="elm_phone" value="" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Dine`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
