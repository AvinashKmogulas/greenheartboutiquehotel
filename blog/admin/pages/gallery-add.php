		...
		$('#update_form').submit(function(event) {
			...
			.done(function(data) {
				...
				if (! data.success) {
					...
					//alert(data.message);
					window.location = '?dispatch=gallery';
				}				
			})
			.fail(function(data) {
				// show any errors
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="previewHolder">
											...
											<div id="image-holder1"><img class="previewImage" src="../assets/img/gallery/" style="width:300px;" alt="" /></div><br /><br />
								...
								<div class="col-md-6">
									<div class="well well-sm no-shadow">
										...
										<div class="box-body">
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterStay]" id="elm_filter_stay" value="Yes" />&nbsp;&nbsp;&nbsp;Stay</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterDine]" id="elm_filter_dine" value="Yes" />&nbsp;&nbsp;&nbsp;Dine</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterWeddings]" id="elm_filter_weddings" value="Yes" />&nbsp;&nbsp;&nbsp;Weddings</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterEvents]" id="elm_filter_events" value="Yes" />&nbsp;&nbsp;&nbsp;Events</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterExperience]" id="elm_filter_experience" value="Yes" />&nbsp;&nbsp;&nbsp;Experience</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterOthers]" id="elm_filter_others" value="Yes" />&nbsp;&nbsp;&nbsp;Others</label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Gallery`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
						...
						<div class="box-footer">
							<input type="hidden" name="form_data[PropertyID]" id="elm_propertyid" value="<?php echo $pid ?>" />
