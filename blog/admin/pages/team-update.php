	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: './pages/f-team-update.php?id=<?php echo $id ?>', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=team';
				}				
			})
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `Team` WHERE `ID` = ".$id);
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="elm_designation">Designation</label>
								<input type="text" class="form-control" name="form_data[Designation]" id="elm_designation" value="<?php echo $obj->Designation ?>" />
							</div>
							
							<div class="form-group">
								<label for="elm_description">Description</label>
								<textarea class="form-control" name="form_data[Description]" id="elm_description" rows="3"><?php echo $obj->Description ?></textarea>
							</div>
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/team/<?php echo $obj->Pic ?>" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
