	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: './pages/f-dine-update.php?id=<?php echo $id ?>', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=dine';
				}				
			})
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#">Dine</a></li>
		</ol>
	</section>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `Dine` WHERE `ID` = ".$id);
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="elm_subtitle">Sub Title</label>
										<input type="text" class="form-control" name="form_data[SubTitle]" id="elm_subtitle" value="<?php echo $obj->SubTitle ?>" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="elm_cuisine">Cuisine</label>
										<input type="text" class="form-control" name="form_data[Cuisine]" id="elm_cuisine" value="<?php echo $obj->Cuisine ?>" />
									</div>
									
									<div class="form-group">
										<label for="elm_diningtime">Dining Timings</label>
										<input type="text" class="form-control" name="form_data[Timings]" id="elm_diningtime" value="<?php echo $obj->Timings ?>" />
									</div>
									
									<div class="form-group">
										<label for="elm_phone">Phone</label>
										<input type="text" class="form-control" name="form_data[Phone]" id="elm_phone" value="<?php echo $obj->Phone ?>" />
									</div>
								</div>
							</div>
