<?php
	...
	if (! empty($errors)) {
		...
		$query = 	"INSERT INTO `ThingsToDo` ( `Title`, `Description`, `Pic`, `SortOrder`, `Status`) 
					VALUES 
					(
		...
		if ($mysqli->query($query)) {
			...
			if (!empty($_FILES["fileUpload1"]["name"]))	move_uploaded_file($_FILES["fileUpload1"]["tmp_name"], "../../assets/img/thingstodo/".$ufile1_path);
			$data['success'] = true;
