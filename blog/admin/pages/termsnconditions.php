	...
	$(document).ready(function() {
		$('form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: './pages/f-termsnconditions-update.php', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=termsnconditions&st=up';
				}				
			})
...
<div class="content-wrapper">
	...
	<section class="content-header">
	  	...
	  	<ol class="breadcrumb">
			...
			<li class="active">Terms n Conditions</li>
	  	</ol>
	</section>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `Termsnconditions` WHERE `ID` = 1");
