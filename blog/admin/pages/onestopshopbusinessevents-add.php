...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				type 		: 'POST',
				url 		: './pages/f-onestopshopbusinessevents-add.php',
				data 		: formData, 
				dataType 	: 'json', 
				processData : false,
			  	contentType : false,
			...
			.done(function(data) {
				...
				if (! data.success) {
					...
					//alert(data.message);
					window.location = '?dispatch=onestopshopbusinessevents';
				}				
			})
			.fail(function(data) {
				// show any errors
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/onestopshopbusinessevents/" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `OneStopShopBusinessEvents`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
