		...
		$('#update_form').submit(function(event) {
			...
			.done(function(data) {
				...
				if (! data.success) {
					...
					//alert(data.message);
					window.location = '?dispatch=offers';
				}				
			})
			.fail(function(data) {
				// show any errors
						...
						<div class="box-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea class="form-control" name="form_data[Inclusions]" id="elm_inclusions" rows="3"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/offers/" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `SpecialOffers`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
