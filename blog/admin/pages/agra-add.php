						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/agra/" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Agra`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
