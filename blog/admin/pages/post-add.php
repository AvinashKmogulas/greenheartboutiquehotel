				...
				<div class="box box-primary">
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						...
						<div class="form-group">
								...
								<input type="text" class="form-control" name="form_data[post_date]" id="post_date" value="" readonly/>
							</div>
							<div class="form-group">
								<label for="elm_description_post">Description</label>
								<textarea class="form-control" name="form_data[description]" id="elm_description_post" rows="3"></textarea>
								<script>
