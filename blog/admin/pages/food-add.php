						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/food/" style="height:200px;" alt="" /></div><br /><br />
								</div>
							</div>
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Food`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
