	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: 'pages/f-gallery-update.php?id=<?php echo $id ?>', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=gallery';
				}				
			})
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `Gallery` WHERE `ID` = ".$id);
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="previewHolder">
											...
											<div id="image-holder1"><img class="previewImage" src="../assets/img/gallery/<?php echo $obj->Pic ?>" style="width:300px;" alt="Pic" /></div><br /><br />
								...
								<div class="col-md-6">
									...
									<div class="well well-sm no-shadow">
										...
										<div class="box-body">
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterStay]" id="elm_filter_stay" value="Yes" <?php if($obj->FilterStay == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Stay</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterDine]" id="elm_filter_dine" value="Yes" <?php if($obj->FilterDine == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Dine</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterWeddings]" id="elm_filter_weddings" value="Yes" <?php if($obj->FilterWeddings == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Weddings</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterEvents]" id="elm_filter_events" value="Yes" <?php if($obj->FilterEvents == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Events</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterExperience]" id="elm_filter_experience" value="Yes" <?php if($obj->FilterExperience == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Experience</label>
											</div>
						
											<div class="form-group">
												<label><input type="checkbox" name="form_data[FilterOthers]" id="elm_filter_others" value="Yes" <?php if($obj->FilterOthers == "Yes"){ ?>checked<?php } ?> />&nbsp;&nbsp;&nbsp;Others</label>
											</div>
										</div>
									</div>
