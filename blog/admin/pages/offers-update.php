	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: './pages/f-offers-update.php?id=<?php echo $id ?>', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=offers';
				}				
			})
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `SpecialOffers` WHERE `ID` = ".$id);
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label for="elm_inclusions">Inclusions</label>
										<textarea class="form-control" name="form_data[Inclusions]" id="elm_inclusions" rows="3"><?php echo $obj->Inclusions ?></textarea>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/offers/<?php echo $obj->Pic ?>" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
...
<script>
  $(function () {
    	...
    	CKEDITOR.replace('elm_inclusions');
  })
</script>
