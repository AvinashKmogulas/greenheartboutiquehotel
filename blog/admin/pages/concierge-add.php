		...
		$('form').submit(function(event) {
			...
			.done(function(data) {
				...
				if (! data.success) {
					...
					//alert(data.message);
					window.location = '?dispatch=concierge';
				}				
			})
			.fail(function(data) {
				// show any errors
					...
					<form role="form" method="post" name="update_form" id="update_form" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="row">
								...
								<?php if($resultsSO = $mysqli->query("SELECT * FROM `Concierge`")) { $SortOrderNumber = $resultsSO->num_rows+1; } ?>
