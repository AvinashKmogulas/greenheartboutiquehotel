	...
	$(document).ready(function() {
		$('#update_form').submit(function(event) {
			...
			$.ajax({
				...
				url 		: './pages/f-awards-update.php?id=<?php echo $id ?>', // the url where we want to POST
			...
			.done(function(data) {
				...
				if ( ! data.success) {
					...
					window.location = 'index.php?dispatch=awards';
				}				
			})
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<?php 
					$results = $mysqli->query("SELECT * FROM `Awards` WHERE `ID` = ".$id);
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="previewHolder">
									...
									<div id="image-holder1"><img class="previewImage" src="../assets/img/awards/<?php echo $obj->Pic ?>" style="height:100px;" alt="" /></div><br /><br />
								</div>
							</div>
