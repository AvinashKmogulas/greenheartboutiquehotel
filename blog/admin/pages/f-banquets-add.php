<?php
	...
	if (! empty($errors)) {
		...
		$query = 	"INSERT INTO `Banquets` ( `Title`, `Description`, `Pic`, `SortOrder`, `Status`) 
					VALUES 
					(
		...
		if ($mysqli->query($query)) {
			...
			if (!empty($_FILES["fileUpload1"]["name"]))	move_uploaded_file($_FILES["fileUpload1"]["tmp_name"], "../../assets/img/banquets/".$ufile1_path);
			$data['success'] = true;
