<?php
	...
	if (! empty($errors)) {
		...
		$query = 	"INSERT INTO `Dine` ( `Title`, `SubTitle`, `Description`, `Cuisine`, `Timings`, `Phone`, `SortOrder`, `Status`) 
					VALUES 
					(
						...
						'" . $mysqli->real_escape_string($_POST['form_data']['Cuisine']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['Timings']) . "',
						'" . $mysqli->real_escape_string($_POST['form_data']['Phone']) . "',
