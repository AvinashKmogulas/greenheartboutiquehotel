...
// if(isset($_POST) && ($_SERVER['REQUEST_METHOD'] == 'POST')){
	...
	$mail->SetFrom("contact@greenheartboutiquehotel.com","Inquiry Email from Greenheart Boutique Dutch Version");
	...
	$mail->Subject ='Inquiry Email from Greenheart Boutique Hotel Dutch Version';
...
date_default_timezone_set("Asia/Calcutta"); 
	...
	$message = "
		<html>
		<head>
		<title>Inquiry Email from Greenheart Boutique Hotel Dutch Version</title>
		</head>
		<body>
