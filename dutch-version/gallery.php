  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 pt-5 text-center">
        <h1 class="mb-0 bread banner-heading">Hotelgalerij - Greenheart Boutique Hotel Suriname</h1>
      </div>
    </div>
  </div>
  ...
  <div class="gallery_home">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12 nopadding">
          <div class="filters button-group filters-button-group">
            ...
            <button class="button" data-filter=".rooms">Hotelkamers</button>
            <button class="button" data-filter=".dine">Restaurant &amp; Meetings</button>
            <button class="button" data-filter=".facilities">Faciliteiten en Diensten </button>
      ...
      <div class="content grid grids row">
        ...
        <!-- <div class="single-content grid-item element-item rooms box-width " data-category="exterior"><a class="example-image-link" href="./gallery/room9.jpg" data-lightbox="example-set"><img class="example-image img-fluid" src="./gallery/room9.jpg" alt="Standard Room"></a></div> -->
        <div class="single-content grid-item element-item More box-width" data-category="exterior">
